...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Destinations</a> <a href="#" class="current">Add Desitnations</a> </div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form enctype="multipart/form-data" method="post" action="{{ url('/admin/add-event') }}" class="form-horizontal" name="add_event" id="add_event" novalidate="novalidate">{{ csrf_field() }}
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="event_sched" id="event_sched" class="span11">
              </div>
            </div>
            <div class="control-group">
